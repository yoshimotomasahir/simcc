...
def GetMaterial(material, density_factor=1):
    ...
    densities = {"CH4": 0.667, "GasAr": 1.662, "GasXe": 5.46}
    if material == "CH4" or material == "Methane":
        ...
        if material == "GasHe":
            ...
            solid_gas = "solid"
            zts, m_fractions = [int(material.replace("Z=", ""))], [1]
            density = 1
